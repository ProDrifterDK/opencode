...
const createEngineerLoopEffect = (input: {
  ...
  Effect.gen(function* () {
    ...
    const engineerPrompt = [
      ...
      `6. After reporting, you may check team_tasks for more unassigned work.`,
      `   - If tasks are available, use team_claim to claim one and work on it.`,
      `   - If NO tasks are available, STOP. Do not keep working or restart your completed task.`,
      ``,
      `Collaboration tools:`,
